...
<div class=" jumbotron-fluid">
	...
	<form method="post" action="updatehere.php">
	<div class="table">
		...
		<table class="table table-light table-bordered text-center bg-secondary text-white">
			...
			<tr>
				...
				<td>
			     <button type="submit" name="update" class="btn btn-outline-info"><a href="updatehere.php?id=<?php
	  	          echo $row['id'];?>" class="text-white">Update</a>
	  	        </td>
			</tr>
